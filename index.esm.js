import React, { useState, Children, cloneElement, createContext, useContext, useRef } from 'react';
  ...
  var nodes = Children.map(children, function (child, index) {
    if (child) {
      ...
      if (childName === 'MenuItem') {
        var node = /*#__PURE__*/cloneElement(child, _objectSpread2({
          index: String(index)
        }, child.props));
        return node;
      }
...
var useMenu = function useMenu(props) {
  ...
  var _useState = useState((_ref = (_props$activeIndex = props.activeIndex) !== null && _props$activeIndex !== void 0 ? _props$activeIndex : props.defaultIndex) !== null && _ref !== void 0 ? _ref : ''),
      _useState2 = _slicedToArray(_useState, 2),
      activeIndex = _useState2[0],
      setActiveIndex = _useState2[1];

  var className = classNames('sp-menu', props.className, _defineProperty({}, "menu-".concat(mode), mode)); // this onSelect will be used by menuItem
...
var useMenuItem = function useMenuItem(props) {
  ...
  var className = classNames('sp-menu-item', props.className, (_classNames = {
...
var MenuItem = function MenuItem(props) {
  ...
  return /*#__PURE__*/React.createElement("li", _objectSpread2({}, params), children);
};
...
var ZoomTransition = function ZoomTransition(props) {
  ...
  }, wrapper ? /*#__PURE__*/React.createElement("div", null, children) : children);
};
...
var useSubMenu = function useSubMenu(props) {
  ...
  var boxClass = classNames('sp-sub-menu', 'sp-menu-item', props.className, (_classNames = {}, _defineProperty(_classNames, "menu-item-".concat(mode), mode), _defineProperty(_classNames, 'menu-item-active', isActive), _classNames));
...
var SubMenu = function SubMenu(props) {
  ...
  return /*#__PURE__*/React.createElement("li", _objectSpread2({
    className: boxClass
  }, onUlHover), /*#__PURE__*/React.createElement("div", {
    className: "sub-menu-title",
    onClick: onTitleClick
  }, /*#__PURE__*/React.createElement("div", null, props.title), /*#__PURE__*/React.createElement("div", {
    className: "sub-menu-title-suffix"
  }, /*#__PURE__*/React.createElement(RotateTransition, {
    active: visible
  }, /*#__PURE__*/React.createElement(FiChevronDown, {
    className: "sub-menu-title-suffix-icon"
  })))), /*#__PURE__*/React.createElement(ZoomTransition, {
    active: visible
...
var Menu = function Menu(props) {
  ...
  return /*#__PURE__*/React.createElement("ul", _objectSpread2(_objectSpread2({}, params), {}, {
...
var Button = function Button(props) {
  ...
  if (props.type === 'link') return /*#__PURE__*/React.createElement("a", _objectSpread2({}, params), children);
  return /*#__PURE__*/React.createElement("button", _objectSpread2({}, params), children);
};
...
var useUpload = function useUpload(props) {
  ...
  var _useState = useState(defaultFileList !== null && defaultFileList !== void 0 ? defaultFileList : []),
      _useState2 = _slicedToArray(_useState, 2),
...
var icons = {
  success: /*#__PURE__*/React.createElement(AiOutlineCheck, {
    className: iconClass('success')
  }),
  uploading: /*#__PURE__*/React.createElement(VscLoading, {
    className: iconClass('uploading')
  }),
  failed: /*#__PURE__*/React.createElement(AiOutlineInfoCircle, {
    className: iconClass('failed')
  }),
  ready: /*#__PURE__*/React.createElement(VscLoading, {
...
var UploadList = function UploadList(props) {
  ...
  return /*#__PURE__*/React.createElement("ul", {
    ...
    }), file.status ? icons[file.status] : null, /*#__PURE__*/React.createElement("span", {
...
export { Button, index as Foo, Menu, Upload };
